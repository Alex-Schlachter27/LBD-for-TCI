...
const getRvt = async () => {
    ...
    const endpoint = 'http://localhost:3030/TCI-Demon/query';
    ...
    return (await fuseki.getQuery(endpoint, q))
                .map(item => {
                    ...
                    return {ElementID, VICOinst, PCIType, Length, Height, Area, Level, adjacentWall1, adjacentWall2, connectionType1, connectionType2, cornerAngle1, cornerAngle2};
                });
};
...
const getTasks = async () => {
    ...
    const q = `
        ...
        WHERE {
            ...
            ?VICOinst   props:Element_ID            ?ID;
                        ...
                        FILTER (?ElementType = "Element") #Filters only elements which are not cut by location!
                    }
                ORDER BY ?ID`;
    ...
    return (await fuseki.getQuery(endpoint, q))
                .map(item => {
                    ...
                    return {ElementLoid, ElementID, Description, ElementType, CompLoid, takeOffID, taskLoid, Location, locLoid, schedLoid, PlannedStartDate, PlannedEndDate, ActualStartDate, ActualEndDate, ProgressDate, ProgressCompletion, projectGUID};
                });
};
...
const getTCIcalc = async () => {
    ...
    return (await fuseki.getQuery(endpoint, q))
                .map(item => {
                    ...
                    return {ElementID, VICOinst, countDefaultPanel330x45, countDefaultPanel330x60, countDefaultPanel330x90, countDefaultPanel330x120, countDefaultPanel330x240, countDefaultOutsideCorner330x60, countDefaultInsideCorner330x20, countDefaultCoupler, countDefaultPushPullProp, countDefaultTieRod, countDefaultWingnut, countDefaultWaler, countTimberFilling, hasTimberFillinglength, hasMonthlyTCIRent};
...
const getTCILoc = async () => {
    ...
    return (await fuseki.getQuery(endpoint, q))
                .map(item => {
                    ...
                    const locLoid = item.locLoid.value;
                    const Location = item.Location.value;
                    const countDefaultPanel330x45 = parseFloat(item.countDefaultPanel330x45.value, 10);
                    const countDefaultPanel330x60 = parseFloat(item.countDefaultPanel330x60.value, 10);
                    const countDefaultPanel330x90 = parseFloat(item.countDefaultPanel330x90.value, 10);
                    const countDefaultPanel330x120 = parseFloat(item.countDefaultPanel330x120.value, 10);
                    const countDefaultPanel330x240 = parseFloat(item.countDefaultPanel330x240.value, 10);
                    const countDefaultOutsideCorner330x60 = parseFloat(item.countDefaultOutsideCorner330x60.value, 10);
                    const countDefaultInsideCorner330x20 = parseFloat(item.countDefaultInsideCorner330x20.value, 10);
                    ...
                    return {locLoid, Location, countDefaultPanel330x45, countDefaultPanel330x60, countDefaultPanel330x90, countDefaultPanel330x120, countDefaultPanel330x240, countDefaultOutsideCorner330x60, countDefaultInsideCorner330x20, countDefaultCoupler, countDefaultPushPullProp, countDefaultTieRod, countDefaultWingnut, countDefaultWaler, countTimberFilling, hasTimberFillinglength};
                });
};
...
const main = async () => {
    ...
    sql.connect(config, (err) => {
        ...
        //     const adjacentWall1 = Object.keys(walls[0])[7]
        //     const adjacentWall2 = Object.keys(walls[0])[8]
        //     const connectionType1 = Object.keys(walls[0])[9]
        //     const connectionType2 = Object.keys(walls[0])[10]
        //     const cornerAngle1 = Object.keys(walls[0])[11]
        //     const cornerAngle2 = Object.keys(walls[0])[12]
        ...
        //         // INSERT Query
        //         str+=`INSERT INTO ${Table1} VALUES (${ID1}, '${VICOinst}', '${PCIType}', ${Length}, ${Height}, ${Area}, '${Level}', '${adjacentWall1}', '${adjacentWall2}', '${connectionType1}', '${connectionType2}', ${cornerAngle1}, ${cornerAngle2}, '${projectGUID}');\n`
        ...
        //     const schedLoid = Object.keys(tasks[0])[9]
        //     const PlannedStartDate = Object.keys(tasks[0])[10]
        //     const PlannedEndDate = Object.keys(tasks[0])[11]
        //     const ActualStartDate = Object.keys(tasks[0])[12]
        //     const ActualEndDate = Object.keys(tasks[0])[13]
        //     const ProgressDate = Object.keys(tasks[0])[14]
        //     const ProgressCompletion = Object.keys(tasks[0])[15]
        ...
        //     str+=`CREATE TABLE ${Table2} (ID INT IDENTITY(1,1) NOT NULL, ${ElementLoid} varchar(80) NOT NULL PRIMARY KEY, ${ID2} int, ${Description} text, ${ElementType} varchar(80), ${CompLoid} varchar(80), ${takeOffID} varchar(80), ${taskLoid} varchar(80), ${Location} varchar(500), ${locLoid} varchar(80), ${schedLoid} varchar(80), ${PlannedStartDate} datetime, ${PlannedEndDate} datetime, ${ActualStartDate} text NULL, ${ActualEndDate} text NULL, ${ProgressDate} text NULL, ${ProgressCompletion} decimal(3,2) NULL, projectGUID varchar(200));\n`;
        ...
        //         str+=`INSERT INTO ${Table2} VALUES ('${ElementLoid}', ${ID2}, '${Description}', '${ElementType}', '${CompLoid}', '${takeOffID}', '${taskLoid}', '${Location}', '${locLoid}', '${schedLoid}', '${PlannedStartDate}', '${PlannedEndDate}', '${ActualStartDate}', '${ActualEndDate}', '${ProgressDate}', ${ProgressCompletion}, '${projectGUID}');\n`;
    ...
    //         str+=`CREATE TABLE ${Table6} (ID INT IDENTITY(1,1) NOT NULL, ${PeriSecTCI} varchar(500) NOT NULL PRIMARY KEY, ${ProductState6} varchar(80), ${ArtNo6} int, ${PCIType6} varchar(500), ${supportsTCI6} varchar(500), ${Length6} TEXT NULL, ${Height6} TEXT NULL, ${Width6} TEXT NULL, ${Weight6} decimal(10,2), ${SRF6} varchar(500), projectGUID varchar(200));\n`;
    ...
    //         const countDefaultPanel330x45 = Object.keys(tcicalc[0])[2]
    //         const countDefaultPanel330x60 = Object.keys(tcicalc[0])[3]
    //         const countDefaultPanel330x90 = Object.keys(tcicalc[0])[4]
    //         const countDefaultPanel330x120 = Object.keys(tcicalc[0])[5]
    //         const countDefaultPanel330x240 = Object.keys(tcicalc[0])[6]
    //         const countDefaultOutsideCorner330x60 = Object.keys(tcicalc[0])[7]
    //         const countDefaultInsideCorner330x20 = Object.keys(tcicalc[0])[8]
    ...
    //         str+=`CREATE TABLE ${Table7} (ID INT IDENTITY(1,1) NOT NULL, ${ElementID} int NOT NULL PRIMARY KEY, ${VICOinst5} varchar(80), ${countDefaultPanel330x45} int, ${countDefaultPanel330x60} int, ${countDefaultPanel330x90} int, ${countDefaultPanel330x120} int, ${countDefaultPanel330x240} int, ${countDefaultOutsideCorner330x60} int, ${countDefaultInsideCorner330x20} int, ${countDefaultCoupler} int, ${countDefaultPushPullProp} int, ${countDefaultTieRod} int, ${countDefaultWingnut} int, ${countDefaultWaler} int, ${countTimberFilling} int, ${hasTimberFillinglength} decimal(10,2), ${hasMonthlyTCIRent} decimal(10,2), projectGUID varchar(200));\n`;
    ...
    //             // INSERT Query
    //             str+=`INSERT INTO ${Table7} VALUES (${ElementID}, '${VICOinst}', ${countDefaultPanel330x45}, ${countDefaultPanel330x60}, ${countDefaultPanel330x90}, ${countDefaultPanel330x120}, ${countDefaultPanel330x240}, ${countDefaultOutsideCorner330x60}, ${countDefaultInsideCorner330x20}, ${countDefaultCoupler}, ${countDefaultPushPullProp}, ${countDefaultTieRod}, ${countDefaultWingnut}, ${countDefaultWaler}, ${countTimberFilling}, ${hasTimberFillinglength}, ${hasMonthlyTCIRent}, '${projectGUID}');\n`
    //             // str+=`INSERT INTO ${Table7} VALUES (${ElementID}, '${VICOinst}', ${countDefaultPanel330x120}, ${countDefaultPanel330x240}, ${countDefaultCoupler}, ${countDefaultPushPullProp}, ${countDefaultTieRod}, ${countDefaultWingnut}, ${countTimberFilling}, ${hasTimberFillinglength});\n`
    ...
    //         str+=`CREATE TABLE ${Table8} (ID INT IDENTITY(1,1) NOT NULL, ${ElementID8} int NOT NULL PRIMARY KEY, ${VICOinst8} varchar(80), ${PCIType8} varchar(80), ${taskLoid8} varchar(80), ${PlannedStartDate8} datetime, ${PlannedEndDate8} datetime, ${ActualStartDate8} text NULL, ${ActualEndDate8} text NULL, ${ProgressDate8} text NULL, ${ProgressCompletion8} decimal(3,2) NULL, ${installationTimeTCI_h} decimal(10,2) NULL, ${strippingTimeTCI_h} decimal(10,2) NULL, ${dismantlingTimeTCI_h} decimal(10,2) NULL, projectGUID varchar(200));\n`;
    ...
    //     }).pop() || {locLoid:val.locLoid, Location:val.Location, countDefaultPanel330x45:0, countDefaultPanel330x60:0, countDefaultPanel330x90:0, countDefaultPanel330x120:0, countDefaultPanel330x240:0, countDefaultOutsideCorner330x60:0, countDefaultInsideCorner330x20:0, countDefaultCoupler:0, countDefaultPushPullProp:0, countDefaultTieRod:0, countDefaultWingnut:0, countDefaultWaler:0, countTimberFilling:0, hasTimberFillinglength:0};
        
    //     o.countDefaultPanel330x45 += val.countDefaultPanel330x45;
    //     o.countDefaultPanel330x60 += val.countDefaultPanel330x60;
    //     o.countDefaultPanel330x90 += val.countDefaultPanel330x90;
    //     o.countDefaultPanel330x120 += val.countDefaultPanel330x120;
    //     o.countDefaultPanel330x240 += val.countDefaultPanel330x240;
    //     o.countDefaultOutsideCorner330x60 += val.countDefaultOutsideCorner330x60;
    //     o.countDefaultInsideCorner330x20 += val.countDefaultInsideCorner330x20;
    ...
    //     const countDefaultPanel330x459 = Object.keys(mergedObjects[0])[2]
    //     const countDefaultPanel330x609 = Object.keys(mergedObjects[0])[3]
    //     const countDefaultPanel330x909 = Object.keys(mergedObjects[0])[4]
    //     const countDefaultPanel330x1209 = Object.keys(mergedObjects[0])[5]
    //     const countDefaultPanel330x2409 = Object.keys(mergedObjects[0])[6]
    //     const countDefaultOutsideCorner330x609 = Object.keys(mergedObjects[0])[7]
    //     const countDefaultInsideCorner330x209 = Object.keys(mergedObjects[0])[8]
    ...
    //     // str+=`CREATE TABLE ${Table5} (ID INT IDENTITY(1,1) NOT NULL, ${ElementID} int NOT NULL PRIMARY KEY, ${VICOinst} varchar(80), ${countDefaultPanel330x120} int, ${countDefaultPanel330x240} int, ${countDefaultCoupler} int, ${countDefaultPushPullProp} int, ${countDefaultTieRod} int, ${countDefaultWingnut} int, ${countTimberFilling} int, ${hasTimberFillinglength} decimal(10,2));\n`;
    //     str+=`CREATE TABLE ${Table9} (ID INT IDENTITY(1,1) NOT NULL, ${locLoid9} varchar(80) NOT NULL PRIMARY KEY, ${Location9} varchar(80), ${countDefaultPanel330x459} int, ${countDefaultPanel330x609} int, ${countDefaultPanel330x909} int, ${countDefaultPanel330x1209} int, ${countDefaultPanel330x2409} int, ${countDefaultOutsideCorner330x609} int, ${countDefaultInsideCorner330x209} int, ${countDefaultCoupler9} int, ${countDefaultPushPullProp9} int, ${countDefaultTieRod9} int, ${countDefaultWingnut9} int, ${countDefaultWaler9} int, ${countTimberFilling9} int, ${hasTimberFillinglength9} decimal(10,2), projectGUID varchar(200));\n`;
    ...
    //         const countDefaultPanel330x45 = loc.countDefaultPanel330x45 ;
    //         const countDefaultPanel330x60 = loc.countDefaultPanel330x60;
    //         const countDefaultPanel330x90 = loc.countDefaultPanel330x90;
    //         const countDefaultPanel330x120 = loc.countDefaultPanel330x120;
    //         const countDefaultPanel330x240 = loc.countDefaultPanel330x240;
    //         const countDefaultOutsideCorner330x60 = loc.countDefaultOutsideCorner330x60;
    //         const countDefaultInsideCorner330x20 = loc.countDefaultInsideCorner330x20;
    ...
    //         // INSERT Query
    //         str+=`INSERT INTO ${Table9} VALUES ('${locLoid}', '${Location}', ${countDefaultPanel330x45}, ${countDefaultPanel330x60}, ${countDefaultPanel330x90}, ${countDefaultPanel330x120}, ${countDefaultPanel330x240}, ${countDefaultOutsideCorner330x60}, ${countDefaultInsideCorner330x20}, ${countDefaultCoupler}, ${countDefaultPushPullProp}, ${countDefaultTieRod}, ${countDefaultWingnut}, ${countDefaultWaler}, ${countTimberFilling}, ${hasTimberFillinglength}, '${projectGUID}');\n`;
