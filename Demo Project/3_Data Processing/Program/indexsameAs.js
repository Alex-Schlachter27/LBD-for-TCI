...
const getWalls = async () => {
    ...
    const q = `
        ...
        FROM NAMED <http://localhost:3030/TCI-Demon/data/RevitLBS>
        WHERE {
        GRAPH ?g {
...
// WRITE BACK TO FUSEKI
    ...
    const instPFX = 'vicoinst:  <http://test/VICO/>'
    ...
    str+= `PREFIX ${tciPFX}\nPREFIX ${propPFX}\nPREFIX ${rdfPFX}\nPREFIX ${owlPFX}\nPREFIX ${botPFX}\nPREFIX ${rdfsPFX}\nPREFIX ${productPFX}\nPREFIX ${opmPFX}\nPREFIX ${periPFX}\nPREFIX ${lbsPFX}\n\n`
    str+= "INSERT DATA{\n"
    str+= "GRAPH <http://localhost:3030/TCI-Demon/data/RevitLBS> {\n";
    ...
    walls.forEach(wall => {
        ...
        str+= `wallinst:${Revitinst} owl:sameAs vicoinst:${VICOinst}.\n`
        str+= `vicoinst:${VICOinst} owl:sameAs wallinst:${Revitinst}.\n`
    ...
    const updateWalls = async () => {
        ...
        const endpoint = "http://localhost:3030/TCI-Demon/update";
